...
async function evaluateExample(idx) {
  ...
  const prompt = `You are a MAR compliance trainer. A trainee (${LEVEL_LABELS[selectedLevel]}) answered a practice example.
...
Return JSON only, no markdown:
{
  ...
  "modelAnswer": "The ideal complete answer a MAR expert would give, referencing relevant MAR articles where appropriate (3-5 sentences)"
}`;
...
async function sendChat() {
  ...
  loadEl.innerHTML = '<div class="msg-role">AI Coach</div><div class="msg-bubble"><span class="